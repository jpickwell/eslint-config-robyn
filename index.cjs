...
const tsconfig = fs.existsSync(`tsconfig.json`)
	...
	: fs.existsSync(`types/tsconfig.json`) // eslint-disable-line n/no-sync, security/detect-non-literal-fs-filename
...
module.exports = {
	...
	rules: {
		...
		'you-dont-need-momentjs/add': `error`,
		'you-dont-need-momentjs/date': `error`,
		'you-dont-need-momentjs/day': `error`,
		'you-dont-need-momentjs/day-of-year': `error`,
		'you-dont-need-momentjs/days-in-month': `error`,
		'you-dont-need-momentjs/diff': `error`,
		'you-dont-need-momentjs/end-of': `error`,
		'you-dont-need-momentjs/format': `error`,
		'you-dont-need-momentjs/from-now': `error`,
		'you-dont-need-momentjs/hours': `error`,
		'you-dont-need-momentjs/is-after': `error`,
		'you-dont-need-momentjs/is-before': `error`,
		'you-dont-need-momentjs/is-between': `error`,
		'you-dont-need-momentjs/is-date': `error`,
		'you-dont-need-momentjs/is-leap-year': `error`,
		'you-dont-need-momentjs/is-same': `error`,
		'you-dont-need-momentjs/iso-weeks-in-year': `error`,
		'you-dont-need-momentjs/max': `error`,
		'you-dont-need-momentjs/min': `error`,
		'you-dont-need-momentjs/no-dynamic-import-moment': `error`,
		'you-dont-need-momentjs/no-import-moment': `error`,
		'you-dont-need-momentjs/no-moment-constructor': `error`,
		'you-dont-need-momentjs/no-require-moment': `error`,
		'you-dont-need-momentjs/seconds': `error`,
		'you-dont-need-momentjs/start-of': `error`,
		'you-dont-need-momentjs/subtract': `error`,
		'you-dont-need-momentjs/to': `error`,
		'you-dont-need-momentjs/week': `error`,
	},
	settings: {
